...
#define GPCSR_AUDIO_SELECT_OFFSET DICE_REGISTER_GPCSR_AUDIO_SELECT_OFFSET
#define GPCSR_CHIP_ID_OFFSET DICE_REGISTER_GPCSR_CHIP_ID_OFFSET
...
#define CLOCK_CONTROLLER_SYNC_CTRL_OFFSET                                      \
  DICE_REGISTER_CLOCK_CONTROLLER_SYNC_CTRL_OFFSET
#define CLOCK_CONTROLLER_DOMAIN_CTRL_OFFSET                                    \
  DICE_REGISTER_CLOCK_CONTROLLER_DOMAIN_CTRL_OFFSET
...
#define AES_RECEIVER_STAT_ALL_OFFSET DICE_REGISTER_AES_RECEIVER_STAT_ALL_OFFSET
...
#define AUDIO_MIXER_NUMOFCH_OFFSET DICE_REGISTER_AUDIO_MIXER_NUMOFCH_OFFSET

// AVS Audio Receiver Offsets (relative to
// DICE_REGISTER_AVS_AUDIO_RECEIVER_BASE)
#define AVS_AUDIO_RECEIVER_CFG0_OFFSET                                         \
  DICE_REGISTER_AVS_AUDIO_RECEIVER_CFG0_OFFSET
#define AVS_AUDIO_RECEIVER_CFG1_OFFSET                                         \
  DICE_REGISTER_AVS_AUDIO_RECEIVER_CFG1_OFFSET
// ARXn_CFG0 bitfields
...
#define REGISTER_TX_PAR_SPACE_OFFSET DICE_REGISTER_TX_ISOCHRONOUS_BASE_OFFSET

// RX Parameter Space Offsets (relative to DICE_REGISTER_RX_BASE)
#define REGISTER_RX_PAR_SPACE_OFFSET DICE_REGISTER_RX_NUMBER_AUDIO_BASE_OFFSET

// --- Absolute Addresses ---

// GLOBAL_PAR_SPACE absolute addresses (relative to DICE_REGISTER_BASE)
#define GLOBAL_OWNER_ADDR                                                      \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_OWNER_OFFSET)
#define GLOBAL_NOTIFICATION_ADDR                                               \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_NOTIFICATION_OFFSET)
#define GLOBAL_NICK_NAME_ADDR                                                  \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_NICK_NAME_OFFSET)
#define GLOBAL_CLOCK_SELECT_ADDR                                               \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_CLOCK_SELECT_OFFSET)
#define GLOBAL_ENABLE_ADDR                                                     \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_ENABLE_OFFSET)
#define GLOBAL_STATUS_ADDR                                                     \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_STATUS_OFFSET)
#define GLOBAL_EXTENDED_STATUS_ADDR                                            \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_EXTENDED_STATUS_OFFSET)
#define GLOBAL_SAMPLE_RATE_ADDR                                                \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_SAMPLE_RATE_OFFSET)
#define GLOBAL_VERSION_ADDR                                                    \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_VERSION_OFFSET)
#define GLOBAL_CLOCKCAPABILITIES_ADDR                                          \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_CLOCKCAPABILITIES_OFFSET)
#define GLOBAL_CLOCKSOURCENAMES_ADDR                                           \
  (DICE_REGISTER_BASE + DICE_REGISTER_GLOBAL_CLOCKSOURCENAMES_OFFSET)

// TX_PAR_SPACE absolute addresses (relative to DICE_REGISTER_TX_BASE)
#define TX_NUMBER_TX_ADDR                                                      \
  (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_NUMBER_TX_OFFSET)
#define TX_SZ_TX_ADDR (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_SIZE_TX_OFFSET)
#define TX_ISOCHRONOUS_BASE_ADDR                                               \
  (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_ISOCHRONOUS_BASE_OFFSET)
#define TX_NUMBER_AUDIO_BASE_ADDR                                              \
  (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_NUMBER_AUDIO_BASE_OFFSET)
#define TX_MIDI_BASE_ADDR                                                      \
  (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_MIDI_BASE_OFFSET)
#define TX_SPEED_BASE_ADDR                                                     \
  (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_SPEED_BASE_OFFSET)
#define TX_NAMES_BASE_ADDR                                                     \
  (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_NAMES_BASE_OFFSET)
#define TX_AC3_CAPABILITIES_BASE_ADDR                                          \
  (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_AC3_CAPABILITIES_BASE_OFFSET)
#define TX_AC3_ENABLE_BASE_ADDR                                                \
  (DICE_REGISTER_TX_BASE + DICE_REGISTER_TX_AC3_ENABLE_BASE_OFFSET)

// RX_PAR_SPACE absolute addresses (relative to DICE_REGISTER_RX_BASE)
#define RX_NUMBER_RX_ADDR                                                      \
  (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_NUMBER_RX_OFFSET)
#define RX_SZ_RX_ADDR (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_SIZE_RX_OFFSET)
#define RX_ISOCHRONOUS_BASE_ADDR                                               \
  (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_ISOCHRONOUS_BASE_OFFSET)
#define RX_SEQ_START_BASE_ADDR                                                 \
  (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_SEQ_START_BASE_OFFSET)
#define RX_NUMBER_AUDIO_BASE_ADDR                                              \
  (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_NUMBER_AUDIO_BASE_OFFSET)
#define RX_MIDI_BASE_ADDR                                                      \
  (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_MIDI_BASE_OFFSET)
#define RX_NAMES_BASE_ADDR                                                     \
  (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_NAMES_BASE_OFFSET)
#define RX_AC3_CAPABILITIES_BASE_ADDR                                          \
  (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_AC3_CAPABILITIES_BASE_OFFSET)
#define RX_AC3_ENABLE_BASE_ADDR                                                \
  (DICE_REGISTER_RX_BASE + DICE_REGISTER_RX_AC3_ENABLE_BASE_OFFSET)
...
#define DICE_EAP_CAPABILITY_SPACE_ADDR                                         \
  (DICE_EAP_BASE_ADDR + DICE_EAP_CAPABILITY_SPACE_OFFSET)
#define DICE_EAP_CMD_SPACE_ADDR (DICE_EAP_BASE_ADDR + DICE_EAP_CMD_SPACE_OFFSET)
#define DICE_EAP_MIXER_SPACE_ADDR                                              \
  (DICE_EAP_BASE_ADDR + DICE_EAP_MIXER_SPACE_OFFSET)
#define DICE_EAP_PEAK_SPACE_ADDR                                               \
  (DICE_EAP_BASE_ADDR + DICE_EAP_PEAK_SPACE_OFFSET)
#define DICE_EAP_NEW_ROUTING_SPACE_ADDR                                        \
  (DICE_EAP_BASE_ADDR + DICE_EAP_NEW_ROUTING_SPACE_OFFSET)
#define DICE_EAP_NEW_STREAM_CFG_SPACE_ADDR                                     \
  (DICE_EAP_BASE_ADDR + DICE_EAP_NEW_STREAM_CFG_SPACE_OFFSET)
#define DICE_EAP_CURR_CFG_SPACE_ADDR                                           \
  (DICE_EAP_BASE_ADDR + DICE_EAP_CURR_CFG_SPACE_OFFSET)
#define DICE_EAP_STAND_ALONE_CFG_SPACE_ADDR                                    \
  (DICE_EAP_BASE_ADDR + DICE_EAP_STAND_ALONE_CFG_SPACE_OFFSET)
#define DICE_EAP_APP_SPACE_ADDR (DICE_EAP_BASE_ADDR + DICE_EAP_APP_SPACE_OFFSET)
